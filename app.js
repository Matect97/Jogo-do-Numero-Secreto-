// Mudança do Titulo da Page, Normalmente o H1 é responsavel pelo titulo principal 
//let titulo = document.querySelector ('h1');
//titulo.innerHTML = 'Jogo do Numero Secreto';

// Mudança do Primeiro paragrafo abaixo do titulo (H1)
//let paragrafo = document.querySelector ('p');
//paragrafo.innerHTML = ' Escolha um numero entre 01 e 10';
...
// Função que atribui Valor/Texto a Tag Designada 
